...
public class GamePanel extends JPanel implements Runnable, MouseListener, MouseMotionListener{
    ...
    private static boolean inGodMode = false;
 ...
 else if (inGodMode) godLevel.update();
 else menu.update();
    }
 ...
 else if(inGodMode) godLevel.draw(g);
 else menu.draw(g);
    }
 ...
 try{
     ...
     else if(inGodMode) godLevel.mouse(e.getX(),e.getY());
 ...
 try{
     ...
     if(inGodMode) godLevel.click(e.getX(),e.getY());
